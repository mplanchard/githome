...
const {
  ...
  ColorChooserWidget,
  NumberInputWidget
} = Extension.imports.preferences.widget
const { NotebookPage } = Extension.imports.preferences.notebook
...
function buildPrefsWidget() {
  const { PrefLogger } = Extension.imports.utils
  const { initialize, PROPERTIES } = Extension.imports.settings
